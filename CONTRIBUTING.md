...
Welcome! This document explains how you can contribute to making **eslint-config-auspost** even better.
...
eslint-config-auspost/
 ...
 │
 ├──rules/                        * ES Lint rules are defined here
 │
 ├──index.js                      * Main file (referenced in package.json)
 │
...
Command | Description
:------ | :----------
<pre>npm run release</pre> | Create production version of software, verify code, run unit tests then if everything is ok, release the package<ul><li>Generates `CHANGELOG.md`</li><li>Bumps `package.json`</li><li>Tags the changes with the release</li><li>Requires conventional commit messages to be used</li></ul>
